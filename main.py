...
class MenuJogos(tk.Tk):
    def __init__(self):
        ...
        image1 = Image.open("escolha_seu.png")        
        test = ImageTk.PhotoImage(image1)
        label1 = tkinter.Label(image=test)
        label1.config(width=1280, )
        label1.image = test
        label1.place(x=0, y=0)

        jVelha = ImageTk.PhotoImage(Image.open("jogoVelha.png"))

        

        self.btn_forca = tk.Button(self, text="     Jogar     ",bg="purple", command=self.jogar_velha)
        self.btn_forca.pack(pady=10)
        self.btn_forca.place(x=230, y=310)
        self.btn_forca["font"]=("Georgia", "15", "bold")
        
        

        self.btn_cobrinha = tk.Button(self, text="     Jogar     ",bg="purple", command=self.jogar_cobrinha)
        self.btn_cobrinha.pack(pady=10)
        self.btn_cobrinha.place(x=660, y=310)
        self.btn_cobrinha["font"]=("Georgia", "15","bold")

        self.btn_flappy = tk.Button(self, text="     Jogar     ",bg="purple", command=self.jogar_flappy)
        self.btn_flappy.pack(pady=10)
        self.btn_flappy.place(x=883, y=310)
        self.btn_flappy["font"]=("Georgia", "15", "bold")

        self.btn_dino = tk.Button(self, text="     Jogar     ",bg="purple", command=self.jogar_dino)
        self.btn_dino.pack(pady=10)
        self.btn_dino.place(x= 445, y= 310)
        self.btn_dino["font"]=("Georgia", "15", "bold")
